...
We would love for you to contribute to the Blue Brain InsilicoVSDI project and help make it better
...
to our [GitHub Repository][github]. Even better, you can [submit a Pull Request](#pull-requests)
with a fix.
...
[github]: https://github.com/BlueBrain/insilico-vsdi

# Development Environment

Please make sure to install the project requirements,
see the `install_requires` section of [setup.py](./setup.py).
